...
impl Camera {
    ...
    pub(crate) fn vs_params(&self) -> shd::VsParams {
        shd::VsParams {
            view_projection: self.vp.as_flat_array(),
        } // adapt to generated field
    }
    ...
    pub(crate) fn update(&mut self, view: Size<u32>) {
        ...
        self.vp = self.projection.matrix().matmul(&self.view_matrix());
    }
}
