...
pub const SDL_IMAGE_MICRO_VERSION: u32 = 6;
unsafe extern "C" {
...
pub const IMG_DECODER_STATUS_INVALID: IMG_AnimationDecoderStatus = -1;
#[doc = "< The decoder is ready to decode the next frame"]
pub const IMG_DECODER_STATUS_OK: IMG_AnimationDecoderStatus = 0;
#[doc = "< The decoder failed to decode a frame, call SDL_GetError() for more information."]
pub const IMG_DECODER_STATUS_FAILED: IMG_AnimationDecoderStatus = 1;
#[doc = "< No more frames available"]
pub const IMG_DECODER_STATUS_COMPLETE: IMG_AnimationDecoderStatus = 2;
#[doc = " An enum representing the status of an animation decoder.\n\n \\since This enum is available since SDL_image 3.4.0."]
pub type IMG_AnimationDecoderStatus = core::ffi::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
