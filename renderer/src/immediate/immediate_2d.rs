...
/*
    ...
    Cmdline:
        sokol-shdc -i shaders/immediate-2d.glsl -o shader.rs -l wgsl:glsl430:hlsl5:metal_macos -f sokol_rust
...
*/
pub const ATTR_SHADER_POSITION: usize = 0;
pub const ATTR_SHADER_COLOR: usize = 1;
pub const ATTR_SHADER_UV: usize = 2;
...
*/
pub const VS_SOURCE_GLSL430: [u8; 330] = [
...
*/
pub const FS_SOURCE_GLSL430: [u8; 139] = [
...
/*
    ...
    void vert_main()
    {
        gl_Position = mul(float4(position, 1.0f), _19_view_projection);
        v_color = color;
    }
...
*/
pub const VS_SOURCE_HLSL5: [u8; 861] = [
    ...
    0x31,0x2e,0x30,0x66,0x29,0x2c,0x20,0x5f,0x31,0x39,0x5f,0x76,0x69,0x65,0x77,0x5f,
    0x70,0x72,0x6f,0x6a,0x65,0x63,0x74,0x69,0x6f,0x6e,0x29,0x3b,0x0a,0x20,0x20,0x20,
...
*/
pub const FS_SOURCE_HLSL5: [u8; 445] = [
...
/*
    ...
    {
        main0_out out = {};
        out.gl_Position = _19.view_projection * float4(in.position, 1.0);
        out.v_color = in.color;
        return out;
    }

*/
pub const VS_SOURCE_METAL_MACOS: [u8; 548] = [
    ...
    0x6e,0x20,0x3d,0x20,0x5f,0x31,0x39,0x2e,0x76,0x69,0x65,0x77,0x5f,0x70,0x72,0x6f,
    0x6a,0x65,0x63,0x74,0x69,0x6f,0x6e,0x20,0x2a,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,
...
*/
pub const FS_SOURCE_METAL_MACOS: [u8; 319] = [
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
/*
    ...
    fn main_1() {
      gl_Position = (x_19.view_projection * vec4f(position_1.x, position_1.y, position_1.z, 1.0f));
      v_color = color;
      return;
    }
    ...
    @vertex
    fn main(@location(0) position_1_param : vec3f, @location(1) color_param : vec4f, @location(2) uv_param : vec2f) -> main_out {
...
*/
pub const VS_SOURCE_WGSL: [u8; 826] = [
    ...
    0x3e,0x20,0x78,0x5f,0x31,0x39,0x20,0x3a,0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,
    ...
    0x74,0x65,0x3e,0x20,0x76,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3a,0x20,0x76,0x65,
    ...
    0x5f,0x31,0x39,0x2e,0x76,0x69,0x65,0x77,0x5f,0x70,0x72,0x6f,0x6a,0x65,0x63,0x74,
    0x69,0x6f,0x6e,0x20,0x2a,0x20,0x76,0x65,0x63,0x34,0x66,0x28,0x70,0x6f,0x73,0x69,
    ...
    0x69,0x6f,0x6e,0x28,0x31,0x29,0x20,0x63,0x6f,0x6c,0x6f,0x72,0x5f,0x70,0x61,0x72,
    ...
    0x67,0x6c,0x5f,0x50,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x2c,0x20,0x76,0x5f,0x63,
...
*/
pub const FS_SOURCE_WGSL: [u8; 358] = [
    0x64,0x69,0x61,0x67,0x6e,0x6f,0x73,0x74,0x69,0x63,0x28,0x6f,0x66,0x66,0x2c,0x20,
    0x64,0x65,0x72,0x69,0x76,0x61,0x74,0x69,0x76,0x65,0x5f,0x75,0x6e,0x69,0x66,0x6f,
...
pub fn shader_shader_desc(backend: sg::Backend) -> sg::ShaderDesc {
    ...
    desc.label = c"shader_shader".as_ptr();
    match backend {
        sg::Backend::Glcore => {
            ...
            desc.attrs[1].glsl_name = c"color".as_ptr();
            desc.attrs[2].base_type = sg::ShaderAttrBaseType::Float;
            desc.attrs[2].glsl_name = c"uv".as_ptr();
